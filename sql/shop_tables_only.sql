...
CREATE TABLE IF NOT EXISTS tblShopItem (
    siUuid CHAR(36) PRIMARY KEY COMMENT '商品UUID',
    siId VARCHAR(20) UNIQUE NOT NULL COMMENT '商品业务ID',
...
CREATE TABLE IF NOT EXISTS tblOrder (
    ...
    oUserUuid CHAR(36) NOT NULL COMMENT '用户UUID',
    ...
    FOREIGN KEY (oUserUuid) REFERENCES tbluser(uUuid) ON DELETE CASCADE,
