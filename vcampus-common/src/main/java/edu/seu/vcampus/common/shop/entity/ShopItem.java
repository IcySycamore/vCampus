...
public class ShopItem implements Serializable {
    ...
    /** @return 所属商店ID */
    public String getSiShopId() {
        return siShopId;
    }

    /** @param siShopId 所属商店ID */
    public void setSiShopId(String siShopId) {
        this.siShopId = siShopId;
    }
}
