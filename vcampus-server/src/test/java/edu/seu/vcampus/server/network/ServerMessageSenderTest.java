...
import edu.seu.vcampus.server.network.ServerMessageSender;
...
/**
 * ServerMessageSender 测试：验证 send 通过 MessageStream 把响应发送给对端。
 */
class ServerMessageSenderTest {
    ...
    void sendWritesResponseThroughStream() throws Exception {
        ...
        ServerMessageSender sender = new ServerMessageSender(stream);
