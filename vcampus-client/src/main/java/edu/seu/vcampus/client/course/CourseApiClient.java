...
/**
 * 选课命令的发送与响应校验：把「发一条命令、超时或被拒怎么报错」收在一处。
 *
 * <p>与 {@link CourseService}（业务方法）分开，错误处理策略只需一份：状态码 →
 * {@link ApiException} 的映射改这里就全局生效。
 */
final class CourseApiClient {
     ...
     */
    CourseApiClient(ClientMessageDispatcher dispatcher, long timeoutMillis) {
